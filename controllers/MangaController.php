    ...
    class MangaController extends Controller {
        public function process ($param){
            ...
            if ($rows[0][0] > 0){
                ...
                $mangas = $contentHandler->getContentByAuthorPaginate($table, $user['_id'], $offset, $itemsPerPage, $searchString);

                $this->data['pages'] = $pages;
                $this->data['actualPage'] = $currentPage;
                $this->data['data'] = $mangas;
            }
            
            $this->data['title'] = 'Seznam mangy';
            $this->data['type'] = 'manga';
            $this->head['title'] = 'Gewrit - Manga';
